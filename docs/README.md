...
<h1 align="center">univercraft record</h1>
...
Si vous téléchargez à partir des Releases, sélectionnez le programme d'installation de votre système.
 ...
 Plateforme | Fichier |
| -------- | ---- |
| Windows x64 | `UniverCraft-Record-win-x64.exe ` |
| macOS | `UniverCraft-Record-mac-universal.dmg` |
| Linux x64 | `UniverCraft-Record-linux-x86_64.AppImage` |
